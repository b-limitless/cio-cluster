    ...
    return (
        <div className={`${styles.row} ${styles.childrens}` }>
            <div className={styles.form__row}>
                ...
                {characters.map((character, i) => <CheckboxWithLabel checked = {selectedCharacters.indexOf(character.code) !== -1} name={character.code} onChange={onChangeHandler} key={i} label={character.name}/>)}
                </div>
